...
class PosePainter_flutterKicks extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var pose in poses) {
      ...
      final landmark2 = pose.landmarks[leftpos2]!; //ankel
      final landmark5 = pose.landmarks[leftpos3]!; //knee

      final landmark1 = pose.landmarks[rightpos1]!; // hip
      final landmark3 = pose.landmarks[rightpos2]!; // ankle
      final landmark4 = pose.landmarks[rightpos3]!; // knee

      angle = (atan2(landmark.y - landmark2.y, landmark.x - landmark2.x)) *
          180 ~/
          PI;
      angle1 = (atan2(landmark1.y - landmark3.y, landmark1.x - landmark3.x)) *
          180 ~/
          PI;
